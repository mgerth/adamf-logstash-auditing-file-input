...
public class AdabasAuditingFileInputTest {

    @Test
    public void testAdabasAuditingFileInputPlugin() {
        String prefix = "This is message";
        long eventCount = 5;
        Map<String, Object> configValues = new HashMap<>();
        Configuration config = new ConfigurationImpl(configValues);
        AdabasAuditingFileInput input = new AdabasAuditingFileInput("test-id", config, null);
